        ...
        <div class="container">
            <div class="content" style="display:block;width:1000px;height:562px">
                <div class=container-full>
                    ...
                    <img class="backgroundImage" src="/boy.png">
                    <img class="boyImage" src="/empty-room.jpg">
                    <div class="container">
                        <div class="cube">
...
@font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: url(/src/assets/fonts/JTUSjIg69CK48gW7PXoo9Wdhyzbi.woff2) format('woff2');
...
@font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: url(/src/assets/fonts/JTUSjIg69CK48gW7PXoo9Wlhyw.woff2) format('woff2');
...
.final {
    ...
    padding: 10px;
    height: 100vh;
    background: linear-gradient(45deg, #0e2991, transparent);
